...
<body>
	...
	<div class="d-flex justify-content-center align-items-start" style="min-width: 100em;">
		...
		<div class="sub--menu">
			...
			<div class="sub--menu--mid">
				<table class="sub--menu--table" border="1">
					<tbody>
						<tr>
							<td><a href="${pageContext.request.contextPath}/staffmy/my" >내 정보 조회</a></td>
						</tr>
						<tr>
							<td><a href="${pageContext.request.contextPath}/staffmy/uppass" class="selected--menu">비밀번호 변경</a></td>
						</tr>
		...
		<main>
			...
			<form action="${pageContext.request.contextPath}/staffmy/password" method="post" class="form--container">
