	...
	<div class="d-flex justify-content-center align-items-start" style="min-width: 100em;">
		<div class="sub--menu">
			...
			<div class="sub--menu--mid">
				<table class="sub--menu--table" border="1">
					...
					<tr>
						<td><a href="${pageContext.request.contextPath}/college/">학과</a></td>
					</tr>
					<tr>
		...
		<main>
			...
			<div class="select--button">
				<a href="${pageContext.request.contextPath}/college/collegelist?action=form" class="button">등록</a> 
				<a href="${pageContext.request.contextPath}/college/collegelist?action=delete" class="button">삭제</a>
			</div>
				...
				<div class="total--container">
					<table class="table--container">
						...
						<c:forEach var="college" items="${collegeList}">
							<tr>
								<td>${college.id}</td>
								<td><a href="${pageContext.request.contextPath}/college/collegeDelete?id=${college.id}">${college.name}</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
