	...
	<div class="sub--menu">
		...
		<div class="sub--menu--mid">
			<table class="sub--menu--table" border="1">
				<tr>
					<td><a href="${pageContext.request.contextPath}/college/collegelist" class="selected--menu">단과대학</a></td>
				</tr>
				<tr>
					<td><a href="${pageContext.request.contextPath}/college/collegelist">학과</a></td>
				</tr>
				<tr>
					<td><a href="">강의실</a></td>
				</tr>
