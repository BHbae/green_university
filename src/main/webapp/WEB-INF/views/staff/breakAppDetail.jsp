...
<div class="d-flex justify-content-center align-items-start"
	...
	<div class="sub--menu">
		...
		<div class="sub--menu--mid">
			<table class="sub--menu--table" border="1">
				...
				<tr>
					<td><a href="/break/application" class="selected--menu">휴학
							신청</a></td>
				</tr>
				<tr>
	...
	<main>
		...
		<div class="d-flex flex-column align-items-center" style="width: 100%">
			<form action="/break/application" method="post"
				...
				<div class="document--layout">
					...
					<table border="1">
						...
						<tr>
							...
							<td>${student.id}</td>
							<th>학 년</th>
							<td>${student.grade}학년<input type="hidden"
								name="studentGrade" value="${student.grade}">
							</td>
						</tr>
						<tr>
							<th>전 화 번 호</th>
						...
						<tr>
							<th>기 간</th>
							<td colspan="3">2024년도 1학기부터 &nbsp; <select name="toYear">
						...
						<tr>
							<th>휴 학 구 분</th>
							<td colspan="3"><input type="radio" name="type" value="일반"
								id="일반" checked> <label for="일반" style="margin: 0">일반휴학</label>
								&nbsp; <input type="radio" name="type" value="임신·출산·육아" id="임신">
								<label for="임신" style="margin: 0">임신·출산·육아휴학</label> &nbsp; <input
								type="radio" name="type" value="질병" id="질병"> <label
								for="질병" style="margin: 0">질병휴학</label> &nbsp; <input
								type="radio" name="type" value="창업" id="창업"> <label
								for="창업" style="margin: 0">창업휴학</label> &nbsp; <input
								type="radio" name="type" value="군입대" id="군입대"> <label
								for="군입대" style="margin: 0">군입대휴학</label></td>
						</tr>
						<tr>
							<td colspan="4">
				...
				<button type="submit" class="btn btn-dark"
					onclick="return confirm('휴학을 신청하시겠습니까?')">승인하기</button>
			</form>
		</div>
	</main>
</div>
