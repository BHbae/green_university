...
public class ManagementController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * TODO - 나중에 로그인 검증 처리 맞춰서 하기 if(session==null ||
		 * session.getAttribute("principal")==null) {
		 * response.sendRedirect(request.getContextPath()+"/user/sigin"); return; }
		 */
		// TODO - 유저정보 받아오기
	...
	// 수강 신청 기간 종료
	private void stopStuSub(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws ServletException, IOException {
		StuSubStatus = 2;
	...
	// 수강 신청 기간 시작
	private void startStuSub(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws ServletException, IOException {
		StuSubStatus = 1;
		request.setAttribute("StuSubStatus", StuSubStatus);
		request.getRequestDispatcher("/WEB-INF/views/staff/setStuSubPeriod.jsp").forward(request, response);
	...
	// 수강 신청 기간 페이지 진입
	private void setStuSubPeriod(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws ServletException, IOException {
		request.setAttribute("StuSubStatus", StuSubStatus);
		request.getRequestDispatcher("/WEB-INF/views/staff/setStuSubPeriod.jsp").forward(request, response);
	}
	 ...
	 */
	private void sendBillLetter(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws ServletException, IOException {
	...
	// 휴학 신청 기간 설정
	private void handleBreakApp(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws ServletException, IOException {
	 ...
	 * @throws IOException
	 */
	private void sendBill(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws ServletException, IOException {
	 ...
	 * @throws IOException
	 */
	private void registerStaff(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws ServletException, IOException {
	 ...
	 * @throws IOException
	 */
	private void registerProfessor(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws ServletException, IOException {
	 ...
	 * @throws IOException
	 */
	private void registerStudent(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws ServletException, IOException {
	 ...
	 * @throws IOException
	 */
	private void selectAllProfessor(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws ServletException, IOException {
		int page = 1;
		int pageSize = 20;
	 ...
	 * @throws ServletException
	 */
	private void SelectAllStudent(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws ServletException, IOException {
		int page = 1;
		int pageSize = 20;
...
//		}
	 ...
	 * @throws ServletException
	 */
	private void selectSpecificProfessor(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws ServletException, IOException {
	 ...
	 * @throws IOException
	 */
	private void sendRegisterStaff(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws IOException {
		...
		StaffDTO staff = StaffDTO.builder().name(name).birth_date(birthDate).gender(gender).address(address).tel(tel)
				.email(email).build();
	 ...
	 * @throws IOException
	 */
	private void sendRegisterStudent(HttpServletRequest request, HttpServletResponse response, HttpSession session)
			throws IOException {
		DateTimeFormatter dtfm = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		...
		StudentDTO student = StudentDTO.builder().name(name).birthDate(birthDate).gender(gender).address(address)
				.tel(tel).email(email).deptId(deptId).entranceDate(entranceDate).build();
